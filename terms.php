                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-8" data-gsap-in='{"opacity": 0, "y": 50}' data-gsap-delay="3.5">
                                <div class="nk-entry">
                                    ...
                                    <ul>
                                        <li>We collect personal information such as name, email, and usage data to improve our services.</li>
                                        <li>Your data is encrypted and stored securely on our servers with industry-standard security protocols.</li>
                                        <li>We do not share your personal information with third parties without your explicit consent. <ul>
                                                <li>We collect personal information such as name, email, and usage data to improve our services.</li>
                                                <li>Your data is encrypted and stored securely on our servers with industry-standard security protocols.</li>
                                                <li>We do not share your personal information with third parties without your explicit consent.</li>
