                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="logo">
                                <a href="index.php">
                                    <img class="dark-logo" src="public/assets/images/logo/logo-black.png" alt="Logo Images">
                                    <img class="white-logo" src="public/assets/images/logo/logo-white2.png" alt="Logo Images">
                                </a>
                            </div>
                        </div>
