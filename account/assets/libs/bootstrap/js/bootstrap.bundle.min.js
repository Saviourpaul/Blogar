...
!(function (t, e) {
        ...
        h = {
          ...
          forceUpdate: function () {
            if (!c) {
              ...
              if (mi(e, i)) {
                ((a.rects = {
                  reference: ui(e, Ne(i), "fixed" === a.options.strategy),
                  popper: xe(i),
                }),
                  (a.reset = !1),
  ...
  var _i = gi(),
    bi = gi({ defaultModifiers: [Ve, hi, Re, ve] }),
    vi = gi({ defaultModifiers: [Ve, hi, Re, ve, ci, oi, di, He, li] });
  const yi = Object.freeze(
    ...
    Fi = p() ? "top-start" : "top-end",
    Hi = p() ? "bottom-end" : "bottom-start",
    Wi = p() ? "bottom-start" : "bottom-end",
    Bi = p() ? "left-start" : "right-start",
    zi = p() ? "right-start" : "left-start",
    Ri = {
      autoClose: !0,
  ...
  class Vi extends W {
    ...
    show() {
      ...
      if (!N.trigger(this._element, ki, t).defaultPrevented) {
        if (
          (this._createPopper(),
          "ontouchstart" in document.documentElement &&
    ...
    _completeHide(t) {
      if (!N.trigger(this._element, Oi, t).defaultPrevented) {
    ...
    _getPlacement() {
      ...
      return t.classList.contains("dropup") ? (e ? Fi : Mi) : e ? Wi : Hi;
    }
    _detectNavbar() {
    ...
    static dataApiKeydownHandler(t) {
      ...
      const s = this.matches(Ni)
          ...
          : z.prev(this, Ni)[0] ||
            z.next(this, Ni)[0] ||
            z.findOne(Ni, t.delegateTarget.parentNode),
        o = Vi.getOrCreateInstance(s);
      if (n) return (t.stopPropagation(), o.show(), void o._selectMenuItem(t));
      o._isShown() && (t.stopPropagation(), o.hide(), s.focus());
    }
  }
  (N.on(document, Di, Ni, Vi.dataApiKeydownHandler),
    N.on(document, Di, ji, Vi.dataApiKeydownHandler),
    N.on(document, Si, Vi.clearMenus),
    N.on(document, $i, Vi.clearMenus),
    N.on(document, Si, Ni, function (t) {
  ...
  class on extends H {
    ...
    activate() {
      this._isActive ||
        ...
        N.off(document, Ji),
        N.on(document, Zi, (t) => this._handleFocusin(t)),
        N.on(document, tn, (t) => this._handleKeydown(t)),
        (this._isActive = !0));
    }
    deactivate() {
      this._isActive && ((this._isActive = !1), N.off(document, Ji));
    }
    _handleFocusin(t) {
  ...
  const dn = ".bs.modal",
    ...
    _n = `resize${dn}`,
    bn = `click.dismiss${dn}`,
    vn = `mousedown.dismiss${dn}`,
    yn = `keydown.dismiss${dn}`,
    wn = `click${dn}.data-api`,
    An = "modal-open",
    En = "show",
    Tn = "modal-static",
  ...
  class xn extends W {
    ...
    show(t) {
      this._isShown ||
        ...
        N.trigger(this._element, mn, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        (this._isTransitioning = !0),
    ...
    hide() {
      this._isShown &&
        !this._isTransitioning &&
        (N.trigger(this._element, un).defaultPrevented ||
          ((this._isShown = !1),
          (this._isTransitioning = !0),
    ...
    _triggerBackdropTransition() {
      if (N.trigger(this._element, fn).defaultPrevented) return;
      const t =
  ...
  (N.on(document, wn, '[data-bs-toggle="modal"]', function (t) {
    const e = z.getElementFromSelector(this);
  ...
  class Vn extends W {
    ...
    _addEventListeners() {
      N.on(this._element, zn, (t) => {
        "Escape" === t.key &&
          (this._config.keyboard ? this.hide() : N.trigger(this._element, Fn));
      });
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  (N.on(document, Bn, '[data-bs-toggle="offcanvas"]', function (t) {
    const e = z.getElementFromSelector(this);
    ...
    N.on(window, Sn, () => {
      for (const t of z.find(Nn)) Vn.getOrCreateInstance(t).show();
    }),
    N.on(window, Wn, () => {
  ...
  const Kn = {
    ...
    Yn = (t, e) => {
      ...
      return e.includes(i)
        ? !Qn.has(i) || Boolean(Xn.test(t.nodeValue))
  ...
  class us extends W {
    ...
    dispose() {
      (clearTimeout(this._timeout),
        N.off(this._element.closest(ss), os, this._hideModalHandler),
    ...
    _createTipElement(t) {
      ...
      return (
        e.setAttribute("id", i),
        this._isAnimated() && e.classList.add(es),
        e
      );
    }
    setContent(t) {
    ...
    _setListeners() {
        ...
        if ("click" === e)
          N.on(
            ...
            (t) => {
              ...
              ((e._activeTrigger[ls] = !(e._isShown() && e._activeTrigger[ls])),
                e.toggle());
            },
          );
        else if ("manual" !== e) {
          ...
          (N.on(this._element, t, this._config.selector, (t) => {
            const e = this._initializeOnDelegatedTarget(t);
            ((e._activeTrigger["focusin" === t.type ? as : rs] = !0),
              e._enter());
          }),
      ...
      ((this._hideModalHandler = () => {
        ...
        N.on(this._element.closest(ss), os, this._hideModalHandler));
    }
    _fixTitle() {
