...
<!-- Mirrored from codebucks.in/aquiry/html/ltr/auth-reset-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Dec 2025 11:51:00 GMT -->
<head>

    <meta charset="utf-8">
    <title>Auth Reset Password | Aquiry Admin &amp; Dashboard Template </title>
        ...
        <div class="col-xl-5">
            <div class="row justify-content-center align-items-center p-10 min-vh-100 bg-body-secondary position-relative">
                <div class="col-md-7 col-lg-6 col-xl-8 col-xxl-7">
                    ...
                    <h3 class="mb-3 mt-8">Reset Password</h3>
                    <p class="text-muted mb-8">Enter your new password below and confirm it to securely update your account.</p>
                    <form action="#">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="email" class="form-control" id="Password" placeholder="name@example.com" required>
                        </div>
                        <div class="mb-8">
                            <label for="confirmPassword" class="form-label">Confirm Password</label>
                            <input type="email" class="form-control" id="confirmPassword" placeholder="name@example.com" required>
                        </div>
